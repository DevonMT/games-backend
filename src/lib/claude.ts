...
export async function scoreRecommendations(
  ...
  const prompt = [
    ...
    'every candidate.',
    '',
    'When scoring, factor in content depth relative to the user\'s engagement habits.',
    'The "avg community playtime" field shows how long most players spend with a game.',
    'If the user tends to sink many hours into games (their top titles show 100+ hours),',
    'they likely enjoy deep, content-rich games — prefer candidates with higher avg',
    'community playtime. If the user\'s highest-played games are in the 20-60h range,',
    'they may favor tighter, more focused experiences — penalize games with very high',
    'avg playtime (200h+) slightly unless the genre is a strong match. The goal is to',
    'match content depth to the user\'s actual engagement style, not just genre.',
    '',
    'Candidates:',
    candidateList,
  ].join('\n');
